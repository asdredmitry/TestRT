...
int main()
{
    ...
    camera cam;
    cam.origin = glm::vec3(0.f, 0.0f, 0.f);
    glm::mat3x3 t(cos(M_PI/4), -sin(M_PI/4), 0, sin(M_PI/4), cos(M_PI/4), 0, 0, 0, 1);
    sphere sp(glm::vec3(0.f, 0.f, -1.f), 0.45f,new glass(glm::vec3(1.f, 1.f, 1.f), 1.17)); //new lambertian(glm::vec3(1.f, 0.1f, 0.4f)));
    sphere sp1(glm::vec3(0.f, 0.6f, -2.6f), 0.45f, new metal(glm::vec3(0.5f, 0.5f, 0.5f), 0.0f));
    sphere sp2(glm::vec3(0.f, -100.5f, -1.0f), 100.f, new metal(glm::vec3(0.f, 1.f, 0.f), 0.2f));//glm::vec3(0.8f, 0.8f, 0.8f));
    sphere sp3(glm::vec3(-0.5f, 0.5f, -1.f), 0.30f, new metal(glm::vec3(0.8f, 0.7f, 0.6f), 0.1f));
